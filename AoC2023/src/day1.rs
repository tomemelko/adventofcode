...
mod tests {
  ...
  fn it_works() {
      ...
      assert_eq!(crate::day1::line_sum("44jkrsmcthreekktxlnnzjdslhfsmzl", &mut sm), 43);
      ...
      assert_eq!(crate::day1::line_sum("9threeone98seven1vnnvgxslf", &mut sm), 91);
      assert_eq!(crate::day1::line_sum("sixeighteightztpdhvt2zqjstmzmtzgsfthreezzhhdr", &mut sm), 63);
      assert_eq!(crate::day1::line_sum("twodtbkqsjgtwohfnsqcrmpjfourhkpnsfdkfive6four", &mut sm), 24);
      assert_eq!(crate::day1::line_sum("ggrxkrdzmthree3", &mut sm), 33);
      assert_eq!(crate::day1::line_sum("sixlflcmmjrs5fivenine488", &mut sm), 68);
      assert_eq!(crate::day1::line_sum("four94hmhvlczssonedvgchseven6", &mut sm), 46);
      assert_eq!(crate::day1::line_sum("ssoneightfbfctjqv43psixsevenslqsfpkb1", &mut sm), 11);
      assert_eq!(crate::day1::line_sum("bdpnkb9eightnvtwojxbztssqfmninethree", &mut sm), 93);
      assert_eq!(crate::day1::line_sum("cpcnkvdbrqrxtfnmzbqgffivesix91fivehgrv", &mut sm), 55);
      assert_eq!(crate::day1::line_sum("five5495eight2", &mut sm), 52);
      assert_eq!(crate::day1::line_sum("7foursix93seventwonbhtmfrbqgq", &mut sm), 72);
      assert_eq!(crate::day1::line_sum("tpqhxqqxpcnmlhqhkz123ninefive", &mut sm), 15);
      ...
      assert_eq!(crate::day1::line_sum("gtzdljfdzpdg4zbnzbnxmpcpfsevennine3", &mut sm), 43);
      assert_eq!(crate::day1::line_sum("svfjvnninefourpqsdmjcfhvccnjkpf8", &mut sm), 98);
      assert_eq!(crate::day1::line_sum("dzmoneighttwovk5tvpnmxfive", &mut sm), 15);
      assert_eq!(crate::day1::line_sum("88msthvt4vbmnbrzjone", &mut sm), 81);
      assert_eq!(crate::day1::line_sum("nbgcs8nine", &mut sm), 89);
      assert_eq!(crate::day1::line_sum("4three53pczsx1sevenmzmtrzz", &mut sm), 47);
      assert_eq!(crate::day1::line_sum("four24qphdrxfsf", &mut sm), 44);
      assert_eq!(crate::day1::line_sum("gdgj3f", &mut sm), 33);
      assert_eq!(crate::day1::line_sum("hthphptmmtwo7sixsevenoneightls", &mut sm), 28);
      assert_eq!(crate::day1::line_sum("qxbhjmmqsixfkfn36three6", &mut sm), 66);
      assert_eq!(crate::day1::line_sum("eightmkmdtvkctkvptsbckzpnkhpskdmp3", &mut sm), 83);
      assert_eq!(crate::day1::line_sum("six2twobgzsfsptlqnine42xtmdprjqc", &mut sm), 62);
