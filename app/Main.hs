...
main = do
  ...
  case args of 
    ...
    ["today", "easy"] -> AoC2022Day12.showDay (printDayResult 12) "AoC2022/inputs/Day12/input_simple.txt"
    ["today", "hard"] -> AoC2022Day12.showDay (printDayResult 12) "AoC2022/inputs/Day12/input.txt"
