...
main = do
  ...
  case args of 
    ...
    ["today", "easy"] -> AoC2022Day13.showDay (printDayResult 13) "AoC2022/inputs/Day13/input_simple.txt"
    ["today", "hard"] -> AoC2022Day13.showDay (printDayResult 13) "AoC2022/inputs/Day13/input.txt"
