...
main = do
  ...
  case args of 
    ...
    ["today", "easy"] -> AoC2022Day14.showDay (printDayResult 14) "AoC2022/inputs/Day14/input_simple.txt"
    ["today", "hard"] -> AoC2022Day14.showDay (printDayResult 14) "AoC2022/inputs/Day14/input.txt"
