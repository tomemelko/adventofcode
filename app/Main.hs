...
main = do
  ...
  case args of 
    ...
    ["today", "easy"] -> AoC2022Day9.showDay (printDayResult 9) "AoC2022/inputs/Day9/input_simple.txt"
    ["today", "hard"] -> AoC2022Day9.showDay (printDayResult 9) "AoC2022/inputs/Day9/input.txt"
