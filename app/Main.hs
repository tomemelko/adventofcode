...
main = do
  ...
  case args of 
    ...
    ["today", "easy"] -> AoC2022Day6.showDay (printDayResult 6) "AoC2022/inputs/Day6/input_simple.txt"
    ["today", "hard"] -> AoC2022Day6.showDay (printDayResult 6) "AoC2022/inputs/Day6/input.txt"
